...
<template>
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
        <div class="bg-white p-8 rounded shadow max-w-md w-full">
            <h2 class="text-2xl font-bold mb-6 text-center text-amber-600">Configuration Marchand</h2>

            <div class="mb-4">
                <label class="block text-gray-700">APP ID</label>
                <input v-model="appId" type="text"
                    class="w-full px-4 py-2 border rounded focus:outline-none focus:ring" />
            </div>

            <div class="mb-4">
                <label class="block text-gray-700">APP SECRET</label>
